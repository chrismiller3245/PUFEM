c$Id: umodelf.f,v 1.1 2007/08/15 22:42:22 rlt Exp $
      subroutine umodelf(umat,f,finv,df,detf,be,ta,d,ud,
     &                   hn,h1,nh,ntm,ii,istrt,sig,dd,xlamd,ha,isw)
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      integer    umat,nh,ntm,ii,istrt,isw
      real*8     ta, xlamd,ha
      real*8     f(*),finv(*),df(*),detf(*),be(*),d(*),ud(*)
      real*8     hn(nh),h1(nh),sig(6),dd(6,6,5)
...
c       
c       CM 30/07/2022 - changed dd(6,6) to dd(6,6,5) to compile
c                     - included ii
