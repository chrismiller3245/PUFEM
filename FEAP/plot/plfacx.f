...
c       8. Change np(112) to np(118) for TEMP allocation    15/05/2012
c       9. Change check on faces from different elements    10/06/2013
c      10. Do not check for internal faces for nf = 1       19/02/2014
c-----[--.----+----.----+----.-----------------------------------------]
...
c     No check if only 2 faces

      if(nf.le.2) return

c     Search for matching internal faces and delete
